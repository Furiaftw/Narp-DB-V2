                      ...
                      return (
                        <div
                          ...
                          className={`group flex flex-col max-w-[85%] rounded-2xl px-4 py-2.5 text-sm shadow-xs ${
                            isDeleted
                              ? 'self-end opacity-60 bg-slate-100 border border-slate-200 text-slate-400'
                              : isMe
                                ? isPrivate
                        ...
                        >
                          <div className="flex items-center gap-1.5 mb-1 flex-wrap">
                            ...
                            {/* Edit/Delete buttons — own messages only, not deleted, not system */}
                            {isMe && !isDeleted && (
